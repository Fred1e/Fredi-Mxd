...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Provide me a query ex Who is fredi");
      }
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Provide me a query ex Who is fredi");
    }
...
smd({
  ...
  try {
    ...
    try {
      ...
      console.log("ERROR IN DALLE RESPONCE FROM API FREDIGPT\n", _0x5cee92);
    }
    if (Config.OPENAI_API_KEY == "" || !Config.OPENAI_API_KEY || !("" + Config.OPENAI_API_KEY).startsWith("sk")) {
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/repos/Fred1e/FREDI-MXD");
    let _0x1c73f9 = ("\nFREDI-MD AN CHUDDY BUDDY BOT FOR ENJOYMENT *" + Config.ownername + "*.\n\n  *❲✺❳ Stars:* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  *❲✺❳ Forks:* " + (_0x44f98c?.forks_count || "1000+") + " forks\n  *❲✺❳ Authors:* Fredie-tech\n  *❲✺❳ Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❲✺❳ Repo:* _https://github.com/Fred1e/Fredi-Mxd_\n  *❲✺❳ Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  use: "255752593xxx,Your_text_here",
  fromMe: true,
  filename: __filename
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*FREDI-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("FREDI-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("FREDI-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
