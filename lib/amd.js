...
async function syncdb() {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /255752593977|255620814108|255764182801/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
  ...
  _0x5447f8.ev.on("group-participants.update", async _0x33a505 => {
    try {
      ...
      events.commands.map(async _0x497293 => {
        ...
        if (/on|true|main|all|fredi|smd/gi.test(_0x497293.group)) {
          try {
            _0x497293.function(_0x1684d7, {
              store: store,
              Void: _0x5447f8
  ...
  _0x5447f8.ev.on("groups.upsert", async _0x6ac529 => {
    try {
      events.commands.map(async _0x591343 => {
        if (/on|true|main|all|fredi|smd/gi.test(_0x591343.groupsetting || _0x591343.upsertgroup || _0x591343.groupupsert)) {
          _0x591343.function({
            ..._0x6ac529[0],
            bot: _0x5447f8
          }, {
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /255752593977|255764182801|255620814108/g.test(_0x89b8f6);
      let _0x506b6e = false;
        ...
        if (Object.keys(_0xd559f7 || {}).length > 0) {
          ...
          for (const _0x5701b6 in _0x22ec5b) {
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 = _0x5701b6 + (_0x4fcba7[_0x5701b6] && /.js|.smd|.fredi/gi.test(_0x4fcba7[_0x5701b6]) ? _0x4fcba7[_0x5701b6] : ".smd");
...
Database:  ${(isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "Fredi Default")}
\t_VARS_
    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "✺ " + _0x371309,
          orderTitle: "live",
          sellerJid: "255752593977@s.whatsapp.net"
        }
      };
...
global.toBool = (_0x5f0b1e, _0x23fe95 = false) => /true|yes|ok|act|sure|enable|smd|fredi/gi.test(_0x5f0b1e) ? _0x23fe95 ? true : "true" : _0x23fe95 ? false : "false";
...
<title>Bouncing Text - Fred1e</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
<div class="bounce-text">Fred1e</div>
...
app.get("/fredi", (_0x2e8c1a, _0x30322c) => _0x30322c.type("html").send(html));
...
app.listen(quickport, () => console.log("fredi On  http://localhost:" + quickport + "/  "));
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^fredi_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/fredi;;;/gi, "").replace(/fredi;;;/gi, "").replace(/Fred1e;;;/gi, "").trim();
  ...
  const _0x406ff0 = "/Fred1e/";
  const _0x40fbb4 = toBool(_0x1532e1 || global.IS_FREDI || process.env.IS_FREDI, true) || (await _0x28b1d6(_0x406ff0, "./Dockerfile"));
  if (_0x40fbb4) {
    AstroOfficial = "yes";
    ...
    if (_0x148358 && /fredi/gi.test(_0x148358) && _0x148358.length < 30) {
      try {
