...
yt.getInfo = async (_0x3c2895, _0x49e43c = {}) => {
  try {
    ...
    console.log("./lib/ezra/yt.getInfo()\n", _0x39b819.message);
    return {
      status: false
    };
  }
...
yt.download = async (_0x1ea0cb, _0x5c75ae = {
  ...
  try {
    ...
    let _0x3991fc = _0x150898 + "/Fredi-Mxd " + _0x1ea0cb + "." + _0x35b4d2;
    ...
    console.log("./lib/ezra/yt.dowanload()\n", _0x26244e.message);
    return false;
  }
};
async function sendAnimeReaction(_0x5c448a, _0x46face = "punch", _0x50961f = "", _0x426154 = "") {
  try {
    ...
    return await _0x5c448a.error(_0x1b7c90 + "\nERROR AT : /lib/ezra.js/sendAnimeReaction()\n\ncommand: " + _0x46face);
  }
}
async function sendGImages(_0x4a189d, _0x4eee7c, _0x205b7c = caption, _0x1caf0d = "") {
  try {
    ...
    return console.log("./ezra/asta.js/sendGImages()\n", _0x36d8e7);
  }
}
...
async function forwardMessage(_0x56dbe1, _0x5eaf75, _0x561de2 = "") {
  ...
  if (_0x3af25e) {
    try {
      await fredi.bot.relayMessage(_0x56dbe1, _0x3af25e, {
...
async function randomeFunfacts(_0x1be35e) {
  try {
    ...
    msg.error(_0x1147af);
    console.log("./lib/ezra.js/randomeFunfacts()\n", _0x1147af);
  }
}
async function audioEditor(_0x1ef339, _0x567a0f = "bass", _0x730356 = "") {
  ...
  try {
    ...
    return console.log("./lib/ezra.js/audioEditor()\n", _0x48606a);
  }
}
...
async function sendWelcome(_0x50ffa3, _0x3417a5 = "", _0x27d774 = "", _0x3fa550 = "", _0x7317df = "msg", _0x495ef9 = false) {
  try {
    ...
    if (_0x3417a5) {
      ...
      let _0x23df3f = _0x3417a5.replace(/@user|&user/gi, "@" + _0x50ffa3.senderNum).replace(/@name|&name/gi, _0x50ffa3.senderName || "_").replace(/@gname|&gname/gi, "").replace(/@desc|&desc/gi, "").replace(/@count|&count/gi, "1").replace(/@pp|&pp|@gpp|&gpp|@context|&context/g, "").replace(/@time|&time/gi, _0x50ffa3.time).replace(/@date|&date/gi, _0x50ffa3.date).replace(/@bot|&bot/gi, "" + Config.botname).replace(/@owner|&owner/gi, "" + Config.ownername).replace(/@caption|&caption/gi, caption).replace(/@gurl|@website|&gurl|&website|@link|&link/gi, gurl).replace(/@myyt|&myyt/gi, "https://github/Fred1e").replace(/@telegram|&telegram/gi, global.telegram || "https://t.me/freditech").replace(/@channel|@yt_channel|&channel|&yt_channel/gi, global.YT_PRODUCT || global.YT_CHANNEL || global.YT_PROMOTE || global.YT || "https://github/Fred1e").replace(/@runtime|&runtime|@uptime|&uptime/gi, "" + runtime(process.uptime())).trim();
      try {
    ...
    console.log("./lib/ezra.js/sendWelcome()\n", _0x30453c);
  }
}
    ...
    for (const _0x55bb42 of _0x55b13f) {
      ...
      if (_0x1cf682.length >= 1) {
        ...
        if (_0x243ab6 !== -1) {
          ...
          let _0x192321 = /ezra|smd|message|chat/gi.test(_0xef10c6);
          if (!_0x4656bb[_0x192321 ? "ezra" : _0xef10c6]) {
            _0x4656bb[_0x192321 ? "ezra" : _0xef10c6] = [];
          }
        }
        const _0x26ebaf = _0x1cf682.filter(_0x1fa91c => _0x1fa91c !== "type/" + _0xef10c6 && _0x1fa91c !== "");
        _0xef10c6 = /ezra|smd|message|chat/gi.test(_0xef10c6) ? "ezra" : _0xef10c6;
        if (_0x26ebaf.length > 0) {
          if (_0x22e9cc.includes(_0xef10c6)) {
            ...
            _0x4656bb[/ezra/gi.test(_0xef10c6) ? "ezra" : "text"].push(_0x26ebaf.join(" "));
          }
        }
      }
      _0xef10c6 = null;
...
setMention.cmd = async (_0x501ec5, _0x2a1c43 = "") => {
  try {
    ...
    if (_0x2a1c43 === "get" || _0x2a1c43 === "info" || !_0x2a1c43 && _0x22516b.status && _0x22516b.get) {
      ...
      _0x501ec5.reply("_Read wiki to set mention message https://github.com/Fred1e/Fredi-Mxd/wiki/mention_", {}, "smd");
...
setMention.check = async (_0x373988, _0x3c756b = "", _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes("@" + _0x373988.user.split("@")[0]) || global.mentionasta && (_0x373988.mentionedJid.includes("255752593977@s.whatsapp.net") || _0x373988.mentionedJid.includes("255620814108@s.whatsapp.net") || /255752593977|255620814108/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.AstroOfficial !== "yes") {
        return;
      }
